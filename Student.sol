...
contract Student {
    ...
    function Student(bytes32 _fName, bytes32 _lName, bytes32 _mailingAdd, bytes32 _transcript, bytes32 _visa) public{
...
//This might need to be updated by the government, so it would need a new modifier like onlyGovBody
    function updateVisa(bytes32 _updatedVisa) onlySchool public{
        visa = _updatedVisa;
    }
